...
module Tolk
  class Locale < ActiveRecord::Base
    ...
    attr_accessible :name, :language_name
    ...
    def search_phrases(query, scope, key_query, page = nil, options = {})
      ...
      phrases.page(page).per(per_page)
    end
    ...
    def language_name
      read_attribute(:language_name) || self.name
    end
